...
The recorded two-node, 16-GPU results are available for
[512 tokens](results/cp8-fsdp16-512-e43a04f.json) and
[1,024 tokens](results/cp8-fsdp16-1024-6633465.json).
